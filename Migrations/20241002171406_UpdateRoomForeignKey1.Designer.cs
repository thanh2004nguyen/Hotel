...
namespace Hotel.Migrations
{
    ...
    [Migration("20241002171406_UpdateRoomForeignKey1")]
    partial class UpdateRoomForeignKey1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AmenitiesThemeRoom", b =>
                {
                    b.Property<int>("AmenitiesThemesId")
                        .HasColumnType("int");

                    b.Property<int>("RoomsId")
                        .HasColumnType("int");

                    b.HasKey("AmenitiesThemesId", "RoomsId");

                    b.HasIndex("RoomsId");

                    b.ToTable("AmenitiesThemeRoom");
                });
            ...
            modelBuilder.Entity("AmenitiesThemeRoom", b =>
                {
                    b.HasOne("Hotel.Models.AmenitiesTheme", null)
                        .WithMany()
                        .HasForeignKey("AmenitiesThemesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
