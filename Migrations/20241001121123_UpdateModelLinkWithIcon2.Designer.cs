...
namespace Hotel.Migrations
{
    ...
    [Migration("20241001121123_UpdateModelLinkWithIcon2")]
    partial class UpdateModelLinkWithIcon2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hotel.Models.RoomPolicy", b =>
                {
                    ...
                    b.HasIndex("IconClassId")
                        .IsUnique()
                        .HasFilter("[IconClassId] IS NOT NULL");
            ...
            modelBuilder.Entity("Hotel.Models.RoomPolicy", b =>
                {
                    b.HasOne("Hotel.Models.IconClass", "IconClass")
                        .WithOne("RoomPolicy")
                        .HasForeignKey("Hotel.Models.RoomPolicy", "IconClassId");
            ...
            modelBuilder.Entity("Hotel.Models.RoomProperty", b =>
                {
                    b.HasOne("Hotel.Models.IconClass", "IconClass")
                        ...
                        .HasForeignKey("Hotel.Models.RoomProperty", "IconClassId");
            ...
            modelBuilder.Entity("Hotel.Models.RoomType", b =>
                {
                    b.HasOne("Hotel.Models.IconClass", "IconClass")
                        .WithOne("RoomType")
                        .HasForeignKey("Hotel.Models.RoomType", "IconClassId");
            ...
            modelBuilder.Entity("Hotel.Models.RoomUnity", b =>
                {
                    b.HasOne("Hotel.Models.IconClass", "IconClass")
                        .WithOne("RoomUnity")
                        .HasForeignKey("Hotel.Models.RoomUnity", "IconClassId");
